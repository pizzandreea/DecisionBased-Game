...
public class FemaleGatherer : MonoBehaviour, IInteractable
{
    [SerializeField]
    ...
    public bool Interact(Interactor interactor)
    {
        ...
        // the first time talking to her (we found her)
        if (interactor.foundMom == false)
        {
            interactor.foundMom = true;
            
        }
        if(interactor.hasIngredients == true)
        {
